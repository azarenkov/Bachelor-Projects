...
type orderUseCase interface {
	CreateOrder(ctx context.Context, customerID, itemName, customerEmail string, amount int64, idempotencyKey string) (*domain.Order, error)
...
func (h *Handler) createOrder(c *gin.Context) {
	...
	order, err := h.uc.CreateOrder(c.Request.Context(), req.CustomerID, req.ItemName, req.CustomerEmail, req.Amount, idempotencyKey)
	if err != nil {
